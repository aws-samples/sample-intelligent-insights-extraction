...
class VPCStack(Construct):
    ...
    def __init__(self, scope) -> None:
        ...
        # Create a custom IAM role for VPC Flow Logs
        ...
        # Add required permissions for Flow Logs
        ...
        # Optionally, create a log group with specific retention
        log_group = logs.LogGroup(
            self,
            "VpcFlowLogGroup",
            retention=logs.RetentionDays.THREE_DAYS,  # Adjust retention as needed
        )
        ...
        CfnOutput(
            self, "VPC_ID", value=self.get_vpc().vpc_id, description="Project VPC ID"
        )
